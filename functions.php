...
function perth_scripts() {
	...
	wp_enqueue_script( 'perth-main', get_template_directory_uri() . '/js/main.js', array('jquery'),'', true );		
...
function my_login_head() {
	...
	<style>
		body.login #login h1 a {
			background: url('".get_bloginfo('template_url')."/images/logo.svg') no-repeat scroll center top transparent;

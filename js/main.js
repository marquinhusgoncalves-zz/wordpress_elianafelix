...
jQuery(function($) {
	...
	$(window).resize(function(){
		var headerHeight = $('.site-header').outerHeight();
		$('.header-clone').css('height',headerHeight);
		console.log(jQuery('.site-header').outerHeight(false));
	});
});
...
//Social Icons
jQuery(function($) {
		$('.menu-item-28 a').html('<i class="fa fa-facebook"></i>').css({ 'font-size': 'large','color': '#1B7DA0', 'margin-top': '-4px' });
		$('.menu-item-29 a').html('<i class="fa fa-twitter"></i>').css({ 'font-size': 'large','color': '#1B7DA0', 'margin-top': '-4px' });
		$('.menu-item-30 a').html('<i class="fa fa-linkedin"></i>').css({ 'font-size': 'large','color': '#1B7DA0', 'margin-top': '-4px' });
	}
);